    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-transparent">
            <div class="container-fluid">
                <a class="navbar-brand mx-auto" href="Entrance.html">
                    <img src="images/logo.png" alt="Logo" width="125" height="120" class="d-inline-block align-text-top logo">
                </a>
            </div>
        </nav>
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="display-6">Who's Logging In?</h2><br>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-3 offset-2 bg-white bg-opacity-50 shadow rounded image">
                    <a href="home.php?profile=cashier">
                        <img src="images/prof1.png" alt="Profile 1" class="img-fluid rounded-circle" style="max-width: 300px;">
                    </a>
                </div>
                <div class="col-md-3 offset-2 bg-white bg-opacity-50 shadow rounded image">
                    <a href="adminlogin.html">
                        <img src="images/prof2.png" alt="Profile 2" class="img-fluid rounded-circle" style="max-width: 300px;">
                    </a>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-3">
                            ...
                            <p class="mb-2 small">Connect with us on social media.</p>
                            <div class="d-flex">
                                <a href="https://www.facebook.com/ClassicHomeBrewCafe" target="_blank" class="text-white me-3" aria-label="Facebook">
                                    <img src="images/facebook.png" height="35" width="35">
                                </a>
                                <a href="https://www.instagram.com/homebrewcafeimus" target="_blank" class="text-white me-3" aria-label="Instagram">
